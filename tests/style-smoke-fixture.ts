...
document.body.innerHTML = '<div id="page" class="page-container vertical gap-relaxed"><div id="row" class="horizontal gap-snug"><button id="button" class="btn padding-block-tight padding-inline-snug ground-accent ink-inverse corner-md">x</button></div><div id="popup" class="popup-container ground ink"></div><div class="selectable-group"><button id="options-prefix" class="btn prefix-cell padding-block-snug padding-inline-relaxed position-relative ground ink rule corner-md ruled font-lg font-md font-medium font-mono pressable hover:ground-defined focus:ring active:ground-accent active:ink-inverse disabled:ground-subtle disabled:ink-soft">/</button><button id="options-prefix-selected" class="btn prefix-cell is-selected padding-block-snug padding-inline-relaxed position-relative ground ink rule corner-md ruled font-lg font-md font-medium font-mono pressable hover:ground-defined focus:ring active:ground-accent active:ink-inverse disabled:ground-subtle disabled:ink-soft">;</button></div></div>'
    ...
    <div data-probe="search-view" class="macro-search-view vertical">
      ...
      <div data-probe="search-results" class="macro-search-results grid elastic basis-ratio scroll-auto">
        <div data-probe="search-item" class="macro-search-item grid span-all position-relative selectable" aria-selected="true">
          ...
          <button data-probe="search-edit" class="macro-search-item-edit horizontal padding-tight align-center justify-center position-absolute pressable concealed parent-hover:revealed parent-selected:revealed">edit</button>
        </div>
      </div>
      <footer data-probe="search-footer" class="macro-search-footer horizontal padding-snug justify-between">
        <div><span data-probe="search-shortcut" class="macro-search-shortcut horizontal inline gap-snug align-center">
...
shadow(
  ...
  `<div data-probe="suggestions" class="macro-suggestions-container hidden ground rule corner-lg ruled font-md" style="left: 24px; top: 24px; position: fixed;">
    <div data-probe="suggestions-list" class="macro-suggestions-commands-list horizontal gap-tight padding-tight rule-soft ruled-bottom" role="listbox">
    ...
    <div data-probe="suggestions-footer" class="macro-suggestions-footer horizontal gap-comfortable padding-block-tight padding-inline-comfortable ground ink-soft rule ruled-top font-xs"></div>
  </div>`,
)
shadow(
  ...
  `<div data-probe="deletion" class="macro-suggestions-container delete-confirm ground rule corner-lg ruled font-md">
    <div class="macro-suggestions-commands-list horizontal gap-tight padding-tight rule-soft ruled-bottom" role="listbox">
...
shadow(
  ...
  `<div data-probe="settings-view" class="settings-view vertical scroll-auto">
    <div data-probe="settings-group" class="settings-group grid padding-block-loose padding-inline-separated">
      <div data-probe="settings-row" class="settings-row horizontal gap-relaxed padding-block-snug align-center justify-between">
        <span class="settings-row-label rigid ink font-md">Theme</span>
        <div data-probe="settings-appearance" class="settings-appearance-controls horizontal gap-comfortable align-center">
          <div data-probe="seg-control" class="seg-control horizontal hidden position-relative ground-subtle rule corner-md ruled">
            <button class="seg-option elastic basis-ratio padding-block-tight padding-inline-comfortable position-relative selectable ink-soft rule ruled-right font-sm text-center pressable hover:ground-defined hover:ink checked:ground-accent checked:ink-inverse" aria-checked="true">One</button>
            <button class="seg-option elastic basis-ratio padding-block-tight padding-inline-comfortable position-relative selectable ink-soft rule ruled-right font-sm text-center pressable hover:ground-defined hover:ink checked:ground-accent checked:ink-inverse" aria-checked="false">Two</button>
          </div>
          <button data-probe="settings-prefix" class="btn settings-prefix-btn horizontal rigid padding-block-snug padding-inline-relaxed align-center justify-center position-relative ground-subtle ink rule corner-md ruled font-md font-medium font-mono pressable hover:ground-defined focus:ring active:ground-accent active:ink-inverse disabled:ground-subtle disabled:ink-soft">/</button>
          <button data-probe="settings-export" class="btn rigid padding-block-snug padding-inline-relaxed ground-subtle ink rule corner-md ruled font-md font-medium pressable hover:ground-defined focus:ring active:ground-accent active:ink-inverse disabled:ground-subtle disabled:ink-soft">Export</button>
        </div>
      </div>
    </div>
    <div data-probe="editor-view" class="macro-editor-view vertical padding-loose ink">
      <form data-probe="editor-form" class="editor-form vertical elastic basis-ratio gap-comfortable min-height-none position-relative">
        <div data-probe="editor-topbar" class="editor-topbar horizontal gap-relaxed align-center justify-between">
          <div data-probe="editor-topbar-lead" class="editor-topbar-lead horizontal rigid gap-snug align-center">
            <button data-probe="editor-popout" class="editor-popout horizontal padding-tight align-center justify-center ink-soft corner-sm">↗</button>
          </div>
          <div class="command-suggestion-wrapper editor-command elastic basis-ratio position-relative">
            <div data-probe="command-suggestions" class="command-suggestions hidden position-absolute ground-subtle rule-accent-soft ruled elevated">
              <div data-probe="command-suggestions-label" class="command-suggestions-label padding-block-tight padding-inline-comfortable ink-soft rule ruled-bottom font-sm">Existing</div>
              <div data-probe="command-suggestion-item" class="command-suggestion-item horizontal gap-comfortable padding-block-snug padding-inline-comfortable align-center hidden selectable pressable hover:ground selected:ground-defined" aria-selected="true">
                ...
                <button data-probe="command-suggestion-action" class="command-suggestion-action delete horizontal rigid padding-tight align-center justify-center ink-soft corner-sm pressable concealed parent-hover:revealed parent-selected:revealed">×</button>
              </div>
            </div>
          </div>
        </div>
        <div data-probe="content-editor" class="content-editor editor-content vertical elastic basis-ratio hidden ground-subtle">
          <div data-probe="ce-toolbar" class="ce-toolbar horizontal rigid gap-tight padding-block-tight padding-inline-snug align-center wrap-allowed ground">
            ...
            <div data-probe="ce-style-menu" class="ce-style-menu position-relative">
              <div data-probe="ce-style-dropdown" class="ce-style-dropdown vertical padding-tight position-absolute ground rule corner-md ruled elevated">
                <button data-probe="ce-style-option" class="ce-style-option horizontal gap-snug padding-block-tight padding-inline-snug align-center ink corner-sm font-sm text-start pressable hover:ground-defined">
          ...
          <div data-probe="content-editor-body" class="content-editor-body padding-comfortable scroll-auto ink rule corner-lg ruled font-md focus:rule-accent focus:ring"></div>
        </div>
        <div data-probe="button-group" class="button-group horizontal inline gap-snug">
          <button data-probe="button-cancel" class="btn padding-block-snug padding-inline-relaxed ground ink rule corner-md ruled font-md font-medium pressable hover:ground-defined focus:ring active:ground-accent active:ink-inverse disabled:ground-subtle disabled:ink-soft">Cancel</button>
          <button data-probe="button-save" class="btn btn-success padding-block-snug padding-inline-relaxed ground-pass ink-inverse rule corner-md ruled font-md font-medium pressable focus:ring active:ground-accent active:ink-inverse disabled:ground-subtle disabled:ink-soft">Save</button>
        </div>
      </form>
    </div>
  </div>`,

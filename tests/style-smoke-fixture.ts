...
document.body.innerHTML = '<div id="page" class="page-container vertical gap-lg padding-2xl"><div id="row" class="horizontal gap-sm"><button id="button" class="btn padding-block-xs padding-inline-sm ground-accent ink-inverse corner-md">x</button></div><div id="popup" class="popup-container ground ink"></div><div class="selectable-group"><button id="options-prefix" class="btn prefix-cell padding-block-sm padding-inline-lg position-relative ground ink rule corner-md ruled font-lg font-md font-medium font-mono pressable hover:ground-defined focus:ring active:ground-accent active:ink-inverse disabled:ground-subtle disabled:ink-soft">/</button><button id="options-prefix-selected" class="btn prefix-cell is-selected padding-block-sm padding-inline-lg position-relative ground ink rule corner-md ruled font-lg font-md font-medium font-mono pressable hover:ground-defined focus:ring active:ground-accent active:ink-inverse disabled:ground-subtle disabled:ink-soft">;</button></div></div>'

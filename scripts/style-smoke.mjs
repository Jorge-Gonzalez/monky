...
try {
  ...
  const actual = await page.evaluate(() => {
    ...
    return {
      ...
      search: {
        ...
        inputContainer: shadowTarget('search-input-container', ['padding-top', 'padding-right', 'padding-bottom', 'padding-left', 'border-bottom-width']),
        input: shadowTarget('search-input', ['padding-top', 'padding-right', 'padding-bottom', 'padding-left', 'box-shadow']),
        ...
        footer: shadowTarget('search-footer', ['display', 'justify-content', 'padding-top', 'padding-right', 'padding-bottom', 'padding-left']),
  ...
  "search": {
    ...
    "inputContainer": { "padding-top": "4px", "padding-right": "20px", "padding-bottom": "12px", "padding-left": "20px", "border-bottom-width": "0px" },
    "input": { "padding-top": "8px", "padding-right": "16px", "padding-bottom": "8px", "padding-left": "16px", "box-shadow": "rgba(0, 0, 0, 0.28) 0px 1px 3px 0px inset" },
    ...
    "cell": { "padding-top": "16px", "padding-right": "4px", "padding-bottom": "16px", "padding-left": "0px" },
    "edit": { "position": "absolute", "display": "flex", "align-items": "center", "justify-content": "center", "padding": "4px" },
    "footer": { "display": "flex", "justify-content": "space-between", "padding-top": "8px", "padding-right": "20px", "padding-bottom": "8px", "padding-left": "20px" },

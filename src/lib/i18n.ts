    ...
    settings: {
      ...
      cloudBackup: {
        ...
        status: {
          ...
          tooLarge: 'Your macros ({{kb}} KB) no longer fit your browser account. Export them instead.',
    ...
    settings: {
      ...
      cloudBackup: {
        ...
        status: {
          ...
          tooLarge: 'Tus macros ({{kb}} KB) ya no caben en tu cuenta del navegador. Expórtalas en su lugar.',

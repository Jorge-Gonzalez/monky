...
const translations = {
  en: {
    ...
    settings: {
      ...
      recover: {
        title: 'Recover',
        empty: 'Nothing to recover yet. Your macros are copied automatically before anything is deleted or imported.',
        today: 'today, {{time}}',
        earlier: '{{date}}, {{time}}',
        count: '{{count}} macros',
        fromAnotherDevice: 'from another device',
        restore: 'Restore',
        ...
        status: {
          restored: 'Restored {{count}} macros. The set you had was kept first.',
  ...
  es: {
    ...
    settings: {
      ...
      recover: {
        title: 'Recuperar',
        empty: 'Aún no hay nada que recuperar. Tus macros se copian solas antes de borrar o importar.',
        today: 'hoy, {{time}}',
        earlier: '{{date}}, {{time}}',
        count: '{{count}} macros',
        fromAnotherDevice: 'desde otro dispositivo',
        restore: 'Restaurar',
        ...
        status: {
          restored: 'Se restauraron {{count}} macros. El conjunto que tenías se guardó antes.',

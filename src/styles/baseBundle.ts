...
import SEMANTIC_FRAGMENT_STYLES from './fragments/semantic-fragments.css?raw'

export const STYLE_LAYER_ORDER = '@layer reset, theme, grammar, skin, fragments, components, overrides;'
...
export const BASE_SHADOW_STYLE_INPUTS = {
  ...
  fragments: SEMANTIC_FRAGMENT_STYLES,
} as const

...
const BRIDGE: Record<string, string> = {
  '--base-tone': 'var(--ground)', '--tone-dim': 'var(--ground-subtle)', '--tone': 'var(--ground-defined)',
  '--ink-alt': 'var(--ink-inverse)',
  '--harmonic': 'var(--rule)', '--harmonic-minor': 'var(--rule-soft)',
  '--accent-dim': 'var(--accent-soft)',
  '--status-error': 'var(--fail)', '--status-error-wash': 'var(--fail-faint)',
...
const TONES: Record<string, Record<Mode, Tones>> = {
  humo: {
    light: { base: '#ededed', toneDim: '#e8e9e9', tone: '#dee5ed', ink: '#101624', inkSoft: '#636a76', inkAlt: '#ffffff', harmonic: '#d6d8dc', harmonicMinor: '#e1e2e4', accent: '#3679e4', accentDim: '#c3c7cb', calm: '#00ad54', active: '#df8e01', charged: '#d1431f', still: '#2d5ae1', shadow: 'rgba(0,0,0,0.15)' },
    dark: { base: '#1f2937', toneDim: '#242c3c', tone: '#3b4a61', ink: '#f3f4f6', inkSoft: '#9ca3af', inkAlt: '#ffffff', harmonic: '#374151', harmonicMinor: '#28303b', accent: '#60a5fa', accentDim: '#4b5563', calm: '#9ed999', active: '#f4c762', charged: '#f9699a', still: '#9c81ec', shadow: 'rgba(0,0,0,0.4)' },
  },
  acera: {
    light: { base: '#e0e0e0', toneDim: '#e8e6e6', tone: '#eac8bd', ink: '#25120d', inkSoft: '#5d4f4b', inkAlt: '#ffffff', harmonic: '#e2aea2', harmonicMinor: '#eed1ca', accent: '#c2492a', accentDim: '#e46845', calm: '#00ad54', active: '#df8e01', charged: '#d1431f', still: '#2d5ae1', shadow: 'rgba(0,0,0,0.15)' },
    dark: { base: '#62666a', toneDim: '#6a6e6e', tone: '#565b5f', ink: '#ffffff', inkSoft: '#e4e3cf', inkAlt: '#ffffff', harmonic: '#545b5b', harmonicMinor: '#6c7f81', accent: '#ffb700', accentDim: '#b19e44', calm: '#7ecdab', active: '#e2b37e', charged: '#d36464', still: '#8198df', shadow: 'rgba(0,0,0,0.4)' },
  },
  mar: {

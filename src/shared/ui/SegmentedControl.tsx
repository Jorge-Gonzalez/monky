    ...
    >
      {options.map(opt => (
        <button
          ...
          className="seg-option elastic basis-ratio text-nowrap padding-block-xs padding-inline-md position-relative selectable ink-soft rule ruled-right font-sm text-center pressable hover:ground-defined hover:ink checked:ground-accent checked:ink-inverse"

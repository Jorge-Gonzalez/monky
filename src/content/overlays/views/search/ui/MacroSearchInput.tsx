  ...
  return (
    <div className="macro-search-input-container padding-relaxed rule ruled-bottom">
      <input
        ...
        className="macro-search-input padding-block-snug padding-inline-comfortable ground-subtle ink rule-accent-soft corner-md ruled font-md focus:rule-accent focus:ring"
      />
    </div>
  );
}

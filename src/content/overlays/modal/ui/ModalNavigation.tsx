    ...
    <nav className="modal-nav-container horizontal align-center justify-between padding-inline-relaxed" style={{ borderBottom: '1px solid var(--harmonic)' }}>
      ...
      <div className="horizontal">
        {tabs.map(tab => (
          <button
            key={tab.view}
            className="modal-nav-tab panel-button font-medium horizontal align-center justify-center gap-snug ink-soft hover:ground-subtle hover:ink current:ink-accent current:ground-subtle"

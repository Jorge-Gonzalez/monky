...
import type { ModalNavigationProps, ModalView } from '../types'
...
const EditorIcon = () => (
  ...
  >
    <path
      ...
      stroke-width=".7"
      d="M10.3 3.7l1.9 1.9M2 14l0-.2c.1-.8.2-1.2.3-1.5.1-.3.3-.6.5-.9.2-.3.5-.6 1.1-1.2l7.8-7.8a1.3 1.3 0 0 1 1.9 1.9l-7.9 7.9c-.5.5-.8.8-1.1 1-.3.2-.5.3-.8.4-.3.1-.7.2-1.4.4L2 14Z M 8 14 14 14"
    />
  </svg>
)
...
const SettingsIcon = () => (
  ...
  >
    <path
      ...
      stroke-linejoin="round"
      stroke-width=".7"
      d="M14.8 5.8 13.3 3.2C11.1 4.5 9.5 3.5 9.5 1h-3c0 2.5-1.6 3.5-3.8 2.2L1.2 5.8C3.4 7.1 3.4 8.9 1.2 10.2l1.5 2.6c2.2-1.3 3.8-.3 3.8 2.2h3c0-2.5 1.6-3.5 3.8-2.2l1.5-2.6c-2.2-1.3-2.2-3.1 0-4.4zM8 11a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"
    />
  </svg>
)
...
export function ModalNavigation({ currentView, onViewChange, theme }: ModalNavigationProps) {
  ...
  return (
    <nav
      data-component="modal-nav"
      className="horizontal padding-block-sm padding-inline-xl align-center justify-between min-height-control-3xl"
    >
      <div
        data-component="modal-nav-brand"
      ...
      <div
        data-component="modal-nav-tabs"
        className="horizontal gap-sm padding-xs

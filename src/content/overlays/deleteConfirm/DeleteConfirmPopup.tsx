  ...
  return (
    ...
    >
      ...
      <div className="macro-suggestions-commands-list horizontal padding-tight gap-tight rule-soft ruled-bottom" role="listbox">
        <button
          type="button"
          className="macro-suggestions-command-item delete-confirm-option elastic basis-ratio min-width-none ground-subtle ink rule-soft ruled corner-md hidden truncate font-sm selectable hover:ground-defined hover:rule selected:ground-defined selected:ink-accent selected:rule-accent"
          role="option"
        ...
        <button
          type="button"
          className="macro-suggestions-command-item delete-confirm-option delete-confirm-danger elastic basis-ratio min-width-none ground-subtle ink rule-soft ruled corner-md hidden truncate font-sm selectable hover:ground-fail-faint hover:rule-fail selected:ground-fail-faint selected:ink-fail selected:rule-fail"
          role="option"

  ...
  return (
    <div className="vertical gap-md padding-lg
      ...
      <div className="horizontal gap-md align-center">
        <label htmlFor="language-select" className="boxed
          ink font-sm font-medium">
          {t('settings.language')}
        </label>
        <select id="language-select" value={language} onChange={handleLanguageChange} className="padding-block-sm padding-inline-md fill-inline
          tween-rule-quick
          ground-subtle ink rule corner-3xl ruled font-md
          focus:rule-accent focus:ring" style={{ width: 'auto' }}>
